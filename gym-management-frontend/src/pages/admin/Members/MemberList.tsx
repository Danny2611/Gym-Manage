...
const MemberManagement: React.FC = () => {
 ...
 return (
  <div className="container mx-auto px-4 py-4 sm:py-8">
    ...
    <div className="mb-4 sm:mb-6 grid grid-cols-1 gap-4">
      <div>
    ...
    <div className="mb-4 sm:mb-6 overflow-x-auto">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="w-full sm:w-auto flex overflow-x-auto pb-1 no-scrollbar">
          ...
          <TabsTrigger value="banned" className="text-xs sm:text-sm whitespace-nowrap">
            Đã cấm{" "}
    ...
    <div className="rounded-lg border bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
      {isLoading ? (
        ...
        <div className="flex h-48 sm:h-64 flex-col items-center justify-center gap-2 p-4 text-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-1 text-xs sm:text-sm">
                  <div className="flex justify-between py-1 border-b border-gray-100 dark:border-gray-800">
                    ...
                    <span className="font-medium text-right">{member.email}</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-gray-100 dark:border-gray-800">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <select
                ...
                onChange={handleInputChange}
                className="flex h-8 sm:h-10 w-full rounded-md border border-input bg-background px-3 py-1 sm:py-2 text-xs sm:text-sm"
              >
    ...
    {pagination.totalItems > 0 && (
      <div className="mt-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-t border-gray-200 pb-1 pt-3 dark:border-gray-700">
