  ...
  <div className="container mx-auto px-2 sm:px-4">
    ...
    <div className="mb-4 flex flex-col gap-3 sm:gap-4 md:flex-row">
      ...
      <div className="flex flex-col xs:flex-row items-center gap-2">
        ...
        >
          <SelectTrigger className="w-full xs:w-[180px] text-sm sm:text-base">
        ...
        <Button
          ...
          className="flex items-center gap-1 w-full xs:w-auto text-sm sm:text-base"
        >
        ...
        <TabsContent value={activeTab}>
          {loading ? (
            ...
            <>
                ...
                {memberships.map((membership) => (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs mb-3">
                      <div>
                        <span className="text-gray-500 dark:text-gray-400">Gói tập:</span>
                        <div className="font-medium">{membership.package.name}</div>
                        <div className="text-gray-500 dark:text-gray-400">
                          {membership.package.price.toLocaleString("vi-VN")} VND
                        </div>
                      </div>
                    ...
                    <div className="mb-3">
                      <div className="mb-1 flex justify-between text-xs">
                        <span>
                          {membership.used_sessions} / {membership.used_sessions + membership.available_sessions}
                        </span>
              ...
              <div className="hidden sm:block mb-4 overflow-x-auto rounded-lg border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead className="w-[200px] sm:w-[250px]">
                        <button
                          ...
                          className="flex items-center text-left font-medium text-xs sm:text-sm"
                        >
              ...
              <div className="mt-4">
                <div className="flex flex-col xs:flex-row flex-1 items-center justify-between border-t border-gray-200 pb-1 pt-3 dark:border-gray-700 text-xs sm:text-sm">
                  <span className="mb-2 xs:mb-0">
                    Hiển thị {memberships.length} trên tổng số {totalMembers} hội viên
                  </span>
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-8 text-center dark:border-gray-700 dark:bg-gray-800">
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
                Không tìm thấy hội viên nào. Vui lòng thử lại với tiêu chí khác.
              </p>
            </div>
          )}
          ...
          <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
            <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto p-4 sm:p-6">
              <DialogHeader>
                <DialogTitle className="text-lg sm:text-xl">Chi tiết hội viên</DialogTitle>
              </DialogHeader>
                ...
                <div className="grid gap-4 sm:gap-6">
                          ...
                          <div className="flex justify-between">
                            ...
                            >
                              {viewMembership.status === "active" &&
                                "Đang hoạt động"}
                              {viewMembership.status === "expired" && "Hết hạn"}
                              {viewMembership.status === "pending" &&
                                "Chờ xử lý"}
                              {viewMembership.status === "paused" && "Tạm dừng"}
                            </Badge>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600 dark:text-gray-400">
                  ...
                  <Card>
                    <CardContent className="p-3 sm:p-4 text-sm">
                      ...
                      <div className="h-3 sm:h-4 w-full overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700">
                        <div
                          className="h-full rounded-full bg-blue-500"
                          style={{
                            width: `${calculateProgress(
                  ...
                  <div className="flex flex-col xs:flex-row justify-between gap-2 text-xs sm:text-sm">
                    <span className="text-gray-600 dark:text-gray-400">
